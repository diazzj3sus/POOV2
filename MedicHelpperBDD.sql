...
GOCREATE DATABASE MedicHelpperBDD
GO
USE MedicHelpperBDD
USE master
...
insert into TipoUsuario VALUES('Administrador','Posee todos los permisos dentro del software')
insert into TipoUsuario VALUES('Enfermeria','Encargado de la administraci�n de citas')
insert into TipoUsuario VALUES('Dotores','Encargado de atender a los pacientes en sus consultas')
insert into TipoUsuario VALUES('Farmaceutico','Encargado de la administraci�n de la farmacia')
---
CREATE TABLE Usuarios(
